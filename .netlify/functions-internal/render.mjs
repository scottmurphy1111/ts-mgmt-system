...
return {
	appDir: "_app",
	appPath: "_app",
	assets: new Set(["bg-transparent.png","favicon.png","fonts/Montserrat-Italic-VariableFont_wght.ttf","fonts/Montserrat-VariableFont_wght.ttf"]),
	mimeTypes: {".png":"image/png",".ttf":"font/ttf"},
	_: {
		client: {"start":"_app/immutable/entry/start.0800c160.js","app":"_app/immutable/entry/app.e28b083f.js","imports":["_app/immutable/entry/start.0800c160.js","_app/immutable/chunks/scheduler.e738ec2c.js","_app/immutable/chunks/singletons.d4806386.js","_app/immutable/chunks/paths.78b93b07.js","_app/immutable/chunks/parse.7d180a0f.js","_app/immutable/entry/app.e28b083f.js","_app/immutable/chunks/scheduler.e738ec2c.js","_app/immutable/chunks/index.90039f23.js"],"stylesheets":[],"fonts":[]},
		nodes: [
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/customers/_server.ts.js'))
			},
			{
				id: "/api/customer",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/customer/_server.ts.js'))
			},
			{
				id: "/api/logout",
				pattern: /^\/api\/logout\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/trucks/_server.ts.js'))
			},
			{
				id: "/api/truck",
				pattern: /^\/api\/truck\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/truck/_server.ts.js'))
			},
			{
				id: "/(app)/customers",
				pattern: /^\/customers\/?$/,
			...
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/(authentication)/email-verification/_token_/_server.ts.js'))
			},
			{
				id: "/(app)/launch",
				pattern: /^\/launch\/?$/,
