...
export const component = async () =>
	(component_cache ??= (await import('../entries/pages/(app)/customers/_page.svelte.js')).default);
export { universal };
...
export const stylesheets = [
	'_app/immutable/assets/20.e83aafe2.css',
