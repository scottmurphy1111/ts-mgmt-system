import { c as create_ssr_component, s as subscribe, d as each, a as add_attribute, v as validate_component, m as missing_component, e as escape } from "../../../chunks/ssr.js";
...
const Aside = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  $$unsubscribe_page();
  return `<div class="shadow-md w-64 h-full p-4 bg-white dark:bg-surface-900 z-10"><ul class="m-0 p-0 flex flex-col gap-2 list-none">${each(items, (item) => {
    return `<li><a class="${[
  ...
  return `${validate_component(Toast, "Toast").$$render($$result, {}, {}, {})} ${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
    ...
    header: () => {
      return `${validate_component(AppBar, "AppBar").$$render(
        ...
        {
          trail: () => {
            return `${validate_component(LightSwitch, "LightSwitch").$$render($$result, {}, {}, {})} ${validate_component(UserSettings, "UserSettings").$$render($$result, { userData: data }, {}, {})} `;
          },
          lead: () => {
