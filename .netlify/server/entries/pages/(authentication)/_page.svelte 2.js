...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="h-full p-24"><div class="flex flex-wrap gap-4"><a href="/customers" class="card-hover card shadow-md bg-secondary-to-primary-300-600-token p-8 flex flex-col gap-4 w-96" data-sveltekit-preload-data="tap"><header><h3 class="flex gap-2 h3">${validate_component(
		...
		{},
		{}
	)}TS Mgmt System</h3></header> <section data-svelte-h="svelte-1xlqmdh"><p>Manage Customer Info</p></section> <footer data-svelte-h="svelte-mo76f"><button class="btn btn-primary">Launch</button></footer></a> <a href="/" class="card card-hover shadow-md p-8 flex flex-col gap-4 w-96"><header><h3 class="flex gap-2 h3">${validate_component(
		...
		{},
		{}
	)}TS Lead System</h3></header> <section data-svelte-h="svelte-oqgy7z"><p>Generate New/Potential Customers</p></section> <footer data-svelte-h="svelte-mo76f"><button class="btn btn-primary">Launch</button></footer></a> ${
		data.role === 'ADMIN'
			? `<a href="/admin/users" class="card card-hover shadow-md bg-secondary-to-primary-300-600-token p-8 flex flex-col gap-4 w-96"><header><h3 class="flex gap-2 h3">${validate_component(
			...
			: ``
	}</div></div>  <form method="post" action="?/logout" data-svelte-h="svelte-194btv6"><input type="submit" value="Sign out"></form>`;
});
