...
export const customTheme: CustomThemeConfig = {
	...
	properties: {
		...
		// surface | #525f7a
		'--color-surface-50': '229 231 235', // #e5e7eb
		'--color-surface-100': '220 223 228', // #dcdfe4
		'--color-surface-200': '212 215 222', // #d4d7de
		'--color-surface-300': '186 191 202', // #babfca
		'--color-surface-400': '134 143 162', // #868fa2
		'--color-surface-500': '82 95 122', // #525f7a
		'--color-surface-600': '74 86 110', // #4a566e
		'--color-surface-700': '62 71 92', // #3e475c
		'--color-surface-800': '49 57 73', // #313949
		'--color-surface-900': '40 47 60' // #282f3c
	}
};
